...
const Projects = props => {
	return (
		<div className="page-projects page">
			<Helmet>
        <title>Проекты - Levelup Music</title>
        <meta name="description" content="Levelup Music - проекты" />
    		<meta name="keywords" content="levelup music, проекты levelup music, музыкальный лейбл" />
    	</Helmet>
			<div className="block">
				<div className="block-title left" id="about-us">
					...
					<p className="description">Завершённый или готовящиеся проекты</p>
				</div>
			</div>
			<div className="block">
				<p className="primary">
