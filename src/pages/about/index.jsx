...
export default () => (
	<div className="page-about page">
		...
		<div className="block">
			<p className="primary">
				Молодой и дерзкий музыкальный лейбл. Творческое объединение, где создается{" "}
				только качественный продукт. Разносторонние и опытные МС, сочный звук и свежий{" "}
				взгляд на шоу, профессиональный подход к делу.
			</p>
		</div>
		<div className="block">
			<div className="button-group" style={{justifyContent: 'flex-start'}}>
				...
				<Link to="/people">
					<button className="button">Участники лейбла</button>
				</Link>
			</div>
		</div>
	</div>
